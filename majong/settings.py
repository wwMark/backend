"""
Django settings for majong project.
...
SECRET_KEY = 'django-insecure-@f+0w=yx56or)tv8%*3p0edrp-u3hbtdnn)je-gcn^kir^4x4y'
...
WSGI_APPLICATION = 'majong.wsgi.application'
...
ASGI_APPLICATION = "majong.asgi.application"
